...
echo "Resultados de la busqueda entre las fechas <b>" . $fec1 . "</b> y <b>" . $fec2 . "</b> de <b>Yazmin Albarran</b><br>";
?>
...
<table class="table table-hove table-condensed table-bordered" id="tabladinamicaload_yaz">
  <thead>
    <tr align="center">
  ...
  <?php
  $sql = "SELECT * FROM llenado_formulario WHERE edat='Yazmin Albarran' AND fec5 BETWEEN'$fec1' AND '$fec2' AND conexion LIKE '%i%'";
...
<script type="text/javascript">
  Highcharts.chart('yazmin', {
    chart: {
      type: 'column'
    },
    title: {
      text: 'Resultados de Yazmin Albarrán'
    },
    subtitle: {
      text: ''
    },
